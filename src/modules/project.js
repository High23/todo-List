...
function createAddProjectLI() {
    ...
    addProjectLI.innerHTML = `<img src="./icons/plus.svg" alt="Plus icon" class="plus-icon">
...
function createProject(title) {
    ...
    projectDropDownIcon.setAttribute('src', './icons/triangle-down.png');
...
function newNameSubmitBTN(projectNameForm, projectLI, id) {
    ...
    newNameSubmitBTN.addEventListener('click', () => {
        if (checkIfProjectExists(projectNameForm.childNodes[2].value)) {
            ...
            projectLI.childNodes[1].setAttribute('src', './icons/triangle-down.png');
