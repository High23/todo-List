...
function createTask(title, dueDate, priority, note, origin = '') {
    ...
    checkMark.addEventListener('click', () => {
        ...
        ;(0,_app__WEBPACK_IMPORTED_MODULE_1__.updateID)(taskLI, 'task');
    });
...
function createToDoDetails(priority, note, id, taskDropDownIcon) {
    ...
    editToDoBTN.addEventListener('click', () => {
        ...
        (0,_UI__WEBPACK_IMPORTED_MODULE_0__.deleteAddTaskDiv)();
        (0,_app__WEBPACK_IMPORTED_MODULE_1__.hideAllOtherEditBTNs)(editToDoBTN, 'task');
...
function editToDosInfo(taskLI) {
    ...
    */
    ...
    todoSaveBTN.addEventListener('click', () => {
        ...
        if (!((0,_app__WEBPACK_IMPORTED_MODULE_1__.checkSubmittedForm)(submittedForm))) return;
        const tab = document.querySelector('.title-of-tab').textContent;
        const ToDo = (0,_app__WEBPACK_IMPORTED_MODULE_1__.CreateToDo)(submittedForm);
        ...
        */
        ...
        form.remove();
        (0,_UI__WEBPACK_IMPORTED_MODULE_0__.createAddTaskDiv)();
        (0,_app__WEBPACK_IMPORTED_MODULE_1__.unHideAllEditBTNs)('task');
    });
...
/* harmony export */   createAddTaskDiv: () => (/* binding */ createAddTaskDiv),
/* harmony export */   createLayout: () => (/* binding */ createLayout),
/* harmony export */   deleteAddTaskDiv: () => (/* binding */ deleteAddTaskDiv)
/* harmony export */ });
...
/* harmony import */ var _tabs__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./tabs */ "./src/modules/tabs.js");
...
function createLayout() {
    ...
    createSidebar();
    createToDoContainer();
    (0,_tabs__WEBPACK_IMPORTED_MODULE_4__.inboxTab)();
    (0,_tabs__WEBPACK_IMPORTED_MODULE_4__.todayTab)();
    (0,_tabs__WEBPACK_IMPORTED_MODULE_4__.weekTab)();
    (0,_tabs__WEBPACK_IMPORTED_MODULE_4__.monthTab)();
}
...
function createSidebar() {
    ...
    (0,_project__WEBPACK_IMPORTED_MODULE_1__.createAddProjectLI)();
}
...
function cancelFormBTN(form) {
    ...
    cancelBTN.addEventListener('click', () => {
        form.remove();
        createAddTaskDiv();
        (0,_app__WEBPACK_IMPORTED_MODULE_0__.toggleAllTasksEditBTNs)();
    });
}
...
function submitFormBTN(form) {
    ...
    submitBTN.addEventListener('click', () => {
        const submittedForm = document.querySelectorAll('.todo-form > div');
        if (!((0,_app__WEBPACK_IMPORTED_MODULE_0__.checkSubmittedForm)(submittedForm))) return;
        const tab = document.querySelector('.title-of-tab').textContent;
        const ToDo = (0,_app__WEBPACK_IMPORTED_MODULE_0__.CreateToDo)(submittedForm);
        if ((0,_storage__WEBPACK_IMPORTED_MODULE_3__.checkIfToDoExistsInProjectOrInbox)(ToDo.titleName, tab)) {
            alert('ToDos must have different names');
            return;
        }
        if (tab === 'Inbox') {
            (0,_storage__WEBPACK_IMPORTED_MODULE_3__.addToDoToInbox)(ToDo);
        } else { 
            (0,_storage__WEBPACK_IMPORTED_MODULE_3__.addToDoToProjectStorage)(ToDo, tab);
        }
        (0,_ToDo__WEBPACK_IMPORTED_MODULE_2__.createTask)(ToDo.titleName, ToDo.dueDate, ToDo.priority, ToDo.note);
        form.remove();
        createAddTaskDiv();
        (0,_app__WEBPACK_IMPORTED_MODULE_0__.toggleAllTasksEditBTNs)();
    });
...
function createAddTaskDiv() {
    ...
    addTaskLI.addEventListener('click', () => {
        ;(0,_app__WEBPACK_IMPORTED_MODULE_0__.toggleAllTasksEditBTNs)('hide')
        createTaskForm();
        deleteAddTaskDiv();
    });
...
/* harmony export */   checkSubmittedForm: () => (/* binding */ checkSubmittedForm),
/* harmony export */   hideAllOtherEditBTNs: () => (/* binding */ hideAllOtherEditBTNs),
/* harmony export */   toggleAllProjectsEditBTNs: () => (/* binding */ toggleAllProjectsEditBTNs),
/* harmony export */   toggleAllTasksEditBTNs: () => (/* binding */ toggleAllTasksEditBTNs),
/* harmony export */   unHideAllEditBTNs: () => (/* binding */ unHideAllEditBTNs),
/* harmony export */   updateID: () => (/* binding */ updateID)
/* harmony export */ });
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/format/index.js");
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/isThisMonth/index.js");
...
function CreateToDo(submittedForm) {
    ...
    dueDate = (0,date_fns__WEBPACK_IMPORTED_MODULE_0__["default"])(new Date(dueDate[0], dueDate[1] - 1, dueDate[2]), 'MM/dd/yyyy')
...
function checkSubmittedForm(submittedForm) {
    ...
    if (titleName.length < 1) {
        ...
        return false;
    } else if (!((0,date_fns__WEBPACK_IMPORTED_MODULE_1__["default"])(new Date(dueDate[0], dueDate[1] - 1, dueDate[2])))) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   createAddProjectLI: () => (/* binding */ createAddProjectLI),
/* harmony export */   createProject: () => (/* binding */ createProject),
/* harmony export */   deleteAddProjectLI: () => (/* binding */ deleteAddProjectLI)
/* harmony export */ });
/* harmony import */ var _storage__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./storage */ "./src/modules/storage.js");
/* harmony import */ var _UI__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./UI */ "./src/modules/UI.js");
/* harmony import */ var _tabs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./tabs */ "./src/modules/tabs.js");
...
function createAddProjectLI() {
    ...
    addProjectLI.addEventListener('click', () => {
        (0,_app__WEBPACK_IMPORTED_MODULE_3__.toggleAllProjectsEditBTNs)('hide')
        deleteAddProjectLI();
...
function createProject(title) {
    ...
    projectNameSpan.addEventListener('click', () => {
        (0,_UI__WEBPACK_IMPORTED_MODULE_1__.clearTab)()
...
function cancelProjectNameForm(projectNameForm) {
    ...
    cancelBTN.addEventListener('click', () => {
        ...
        createAddProjectLI();
        (0,_app__WEBPACK_IMPORTED_MODULE_3__.toggleAllProjectsEditBTNs)()
    });
}
...
function submitProjectNameForm(projectNameForm) {
    ...
    submitBTN.addEventListener('click', () => {
        if ((0,_storage__WEBPACK_IMPORTED_MODULE_0__.checkIfProjectExists)(projectNameForm.childNodes[2].value)) {
            alert('Projects must have different names')
            return;
        } else {
            createProject(document.querySelector('#input-project-name').value);
            (0,_storage__WEBPACK_IMPORTED_MODULE_0__.addProjectToStorage)(projectNameForm.childNodes[2].value)
            projectNameForm.remove();
            createAddProjectLI()
            ;(0,_app__WEBPACK_IMPORTED_MODULE_3__.toggleAllProjectsEditBTNs)()
        };
...
function openProject(title, projectLI) {
    ...
    ;(0,_storage__WEBPACK_IMPORTED_MODULE_0__.loadTodos)(projects[projectIndex][[title]])
}
...
function createProjectDetails(id, dropDownIcon) {
    ...
    editBTN.addEventListener('click', () => {
        id = (0,_app__WEBPACK_IMPORTED_MODULE_3__.updateID)(projectLI)
        ;(0,_app__WEBPACK_IMPORTED_MODULE_3__.hideAllOtherEditBTNs)(editBTN, 'project')
    ...
    deleteBTN.addEventListener('click', () => {
        id = (0,_app__WEBPACK_IMPORTED_MODULE_3__.updateID)(projectLI)
        deleteProject(id)
        ;(0,_tabs__WEBPACK_IMPORTED_MODULE_2__.switchTab)()
    });
}
...
function newNameCancelBTN(projectNameForm, projectLI) {
    ...
    newNameCancelBTN.addEventListener('click', () => {
        projectNameForm.remove();
        toggleHidden(projectLI)
        ;(0,_app__WEBPACK_IMPORTED_MODULE_3__.unHideAllEditBTNs)('project');
    });
}
...
/* harmony export */   addToDoToInbox: () => (/* binding */ addToDoToInbox),
/* harmony export */   addToDoToProjectStorage: () => (/* binding */ addToDoToProjectStorage),
/* harmony export */   checkIfProjectExists: () => (/* binding */ checkIfProjectExists),
/* harmony export */   checkIfToDoExistsInProjectOrInbox: () => (/* binding */ checkIfToDoExistsInProjectOrInbox),
/* harmony export */   checkLocalStorageOnPageLoad: () => (/* binding */ checkLocalStorageOnPageLoad),
/* harmony export */   loadProjects: () => (/* binding */ loadProjects),
/* harmony export */   loadTodos: () => (/* binding */ loadTodos),
/* harmony export */   setLocalStorageItemsOnPageLoad: () => (/* binding */ setLocalStorageItemsOnPageLoad)
/* harmony export */ });
...
function loadProjects(projects) {
    (0,_project__WEBPACK_IMPORTED_MODULE_2__.deleteAddProjectLI)();
    for (let i = 0; i < projects.length; i++) {
        let projectName = Object.getOwnPropertyNames(projects[i])[0];
        (0,_project__WEBPACK_IMPORTED_MODULE_2__.createProject)(projectName);
    }
    (0,_project__WEBPACK_IMPORTED_MODULE_2__.createAddProjectLI)();
}

function loadTodos(storage) {
    (0,_UI__WEBPACK_IMPORTED_MODULE_1__.deleteAddTaskDiv)();
    for (let i = 0; i < storage.length ; i++) {
        (0,_ToDo__WEBPACK_IMPORTED_MODULE_0__.createTask)(storage[i].titleName, storage[i].dueDate, storage[i].priority, storage[i].note);
    }
    (0,_UI__WEBPACK_IMPORTED_MODULE_1__.createAddTaskDiv)()
}
...
function inboxTab() {
    ...
    inboxTab.addEventListener('click', () => {
        ...
        ;(0,_UI__WEBPACK_IMPORTED_MODULE_1__.clearTab)();
        const inbox = JSON.parse(localStorage.getItem('inbox'));
        (0,_storage__WEBPACK_IMPORTED_MODULE_2__.loadTodos)(inbox);
    });
}
...
function getTabToDos(tabName) {
    ...
    for (let i = 0; i < inbox.length; i++) {
        if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(inbox[i].dueDate)) && tabName === 'Today') {
            (0,_ToDo__WEBPACK_IMPORTED_MODULE_0__.createTask)(inbox[i].titleName, 
                inbox[i].dueDate, 
                inbox[i].priority, 
                inbox[i].note,
                '(Inbox)')
        } else if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(inbox[i].dueDate)) && tabName === 'Week') {
            (0,_ToDo__WEBPACK_IMPORTED_MODULE_0__.createTask)(inbox[i].titleName, 
                inbox[i].dueDate, 
                inbox[i].priority, 
                inbox[i].note,
                '(Inbox)')
        } else if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(inbox[i].dueDate)) && tabName === 'Month') {
            (0,_ToDo__WEBPACK_IMPORTED_MODULE_0__.createTask)(inbox[i].titleName, 
                inbox[i].dueDate, 
                inbox[i].priority, 
                inbox[i].note,
    ...
    for (let i = 0; i < projects.length; i++) {
        ...
        project.forEach(todo => {
            if ((0,date_fns__WEBPACK_IMPORTED_MODULE_3__["default"])(new Date(todo.dueDate)) && tabName === 'Today') {
                (0,_ToDo__WEBPACK_IMPORTED_MODULE_0__.createTask)(todo.titleName, 
                            todo.dueDate, 
                            todo.priority, 
                            todo.note,
                            `(${projectName})`)
            } else if ((0,date_fns__WEBPACK_IMPORTED_MODULE_4__["default"])(new Date(todo.dueDate)) && tabName === 'Week') {
                (0,_ToDo__WEBPACK_IMPORTED_MODULE_0__.createTask)(todo.titleName,
                            todo.dueDate, 
                            todo.priority, 
                            todo.note,
                            `(${projectName})`)
            } else if ((0,date_fns__WEBPACK_IMPORTED_MODULE_5__["default"])(new Date(todo.dueDate)) && tabName === 'Month') {
                (0,_ToDo__WEBPACK_IMPORTED_MODULE_0__.createTask)(todo.titleName,
                            todo.dueDate, 
                            todo.priority, 
                            todo.note,
...
function adjustTabInfo(tabName) {
    ...
    if (tabName === 'Today') {
        ...
        span.innerHTML = `${(0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(), 'MMM do')}` 
        tabTitle.appendChild(span);
    } else if (tabName === 'Week') {
        tabTitle.textContent = `This ${tabName}`
        span.innerHTML = `${(0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_7__["default"])(new Date()), 'MM/dd')} - ${(0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])((0,date_fns__WEBPACK_IMPORTED_MODULE_8__["default"])(new Date()), 'MM/dd')}`
        tabTitle.appendChild(span);
    } else if (tabName === 'Month') {
        tabTitle.innerHTML = `This ${tabName}`
        span.innerHTML = `${(0,date_fns__WEBPACK_IMPORTED_MODULE_6__["default"])(new Date(), 'MMMM')}`;
        tabTitle.appendChild(span)
    }
}
